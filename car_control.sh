...
# 建構完整指令
docker run -it --rm -v "$(pwd)/src:/workspaces/src" --network inverted_pendulum_bridge_network -p 9090:9090 $device_options --env-file ./.env ghcr.io/otischung/pros_ai_image:latest /bin/bash
